                        ...
                        <div class="mx-auto max-w-7xl md:px-0 sm:px-6 lg:px-8">
                            <div class="overflow-hidden bg-white sm:rounded-lg">
                                <div class="flex justify-between items-end">
                                    <h4>ทั้งหมด {{$faculties->total()}} รายการ</h4>
                                                ...
                                                <tr class="bg-white">
                                                    ...
                                                    <td class="px-6 py-4 text-sm leading-5 whitespace-no-wrap">
                                                        ...
                                                        <x-danger-button
                                                            ...
                                                            wire:click="showFaculty({{ $faculty->id }})">
                                                            Edit
                                                        </x-danger-button>
                                                        <x-danger-button
                                                            x-data=""
    ...
    <x-modal name="delete-modal" :show="$errors->isNotEmpty()" :maxWidth="'md'" focusable>
        <div class="p-6">
            ...
            <p class="mt-1 text-sm text-gray-600">
                {{ __('Are you sure you want to delete เวชภัณฑ์?') }}
            </p>
            ...
            <div class="mt-6 flex justify-end">
                <div class="mt-4 flex justify-end">
                    ...
                    <x-danger-button class="ms-3"
                        x-on:click="deleteFaculty({{ $faculty->id ?? null}})">
                        {{ __('Delete') }}
                    </x-danger-button>
                </div>
            </div>
