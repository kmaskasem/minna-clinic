                        ...
                        <div class="mx-auto max-w-7xl md:px-0 sm:px-6 lg:px-8">
                            <div class="overflow-hidden bg-white sm:rounded-lg">
                                <div class="flex justify-between items-end">
                                    <h4>ทั้งหมด {{$icd10s->total()}} รายการ</h4>
                                            ...
                                            <tbody class="bg-white divide-y divide-gray-200 divide-solid">
                                                ...
                                                <tr class="bg-white">
                                                    <td class="px-6 py-4 text-sm leading-5 whitespace-no-wrap">
                                                        {{ ($icd10s->currentPage() - 1) * $icd10s->perPage() + $index + 1 }}
                                                    </td>
                                                    <td class="px-6 py-4 text-sm leading-5 whitespace-no-wrap">
                                                        {{$icd10->code}}
                                                    </td>
                                                    ...
                                                    <td class="px-6 py-4 text-sm leading-5 whitespace-no-wrap">
                                                        ...
                                                        <x-danger-button
                                                            ...
                                                            wire:click="showFaculty({{ $icd10->id }})">
                                                            Edit
                                                        </x-danger-button>
                                                        <x-danger-button
                                                            x-data=""
    ...
    <x-modal name="delete-modal" :show="$errors->isNotEmpty()" :maxWidth="'md'" focusable>
        <div class="p-6">
            ...
            <h2 class="text-lg font-medium text-gray-100">
                {{ __('Delete การวินิจฉัย') }}
            </h2>

            <p class="mt-1 text-sm text-gray-600">
                {{ __('Are you sure you want to delete icd10?') }}
            </p>
            ...
            <div class="mt-6 flex justify-end">
                <div class="mt-4 flex justify-end">
                    ...
                    <x-danger-button class="ms-3"
                        x-on:click="deleteFaculty({{ $icd10->id ?? null}})">
                        {{ __('Delete') }}
                    </x-danger-button>
                </div>
            </div>
    ...
    <x-modal name="create-modal" :show="$errors->isNotEmpty()" :maxWidth="'md'" focusable>
        <div class="p-6">
            ...
            <form wire:submit="create">
                ...
                <!-- Thai Name -->
                <div class="mt-4">
                    <x-input-label for="name_th" :value="__('Thai Name')" />
                    <x-text-input wire:model="name_th" id="name_th" class="block mt-1 w-full" type="text" name="name_th" required />
                ...
                <div class="mt-4">
                    ...
                    <x-text-input wire:model="name_en" id="name_en" class="block mt-1 w-full" type="text" name="name_en" />
