                        ...
                        <div class="mx-auto max-w-7xl md:px-0 sm:px-6 lg:px-8">
                            <div class="overflow-hidden bg-white sm:rounded-lg">
                                <div class="flex justify-between items-end">
                                    <h4>ทั้งหมด {{$drugs->total()}} รายการ</h4>
                                ...
                                <div class="py-6 overflow-hidden overflow-x-auto bg-white border-b border-gray-200 ">
                                    ...
                                    <div class="overflow-x-auto max-w-full align-middle">
                                        <table class="min-w-full border divide-y divide-gray-200">
                                            <thead>
                                                <tr>
                                                    <th class="px-3 py-3 text-left bg-gray-50 w-20">
                                                    ...
                                                    <th class="px-3 py-3 text-left bg-gray-50 w-80">
                                                        <span class="text-xs font-medium leading-4 tracking-wider text-gray-500 uppercase">
                                                            Name
                                                        </span>
                                                    </th>
                                                    <th class="px-3 py-3 text-left bg-gray-50 w-60">
                                                        <div class="flex justify-between">
                                                            <span class="text-xs font-medium leading-4 tracking-wider text-gray-500 uppercase">
                                                                หน่วยนับ<br />(แบ่งจ่าย)
                                                            </span>
                                                            <span class="text-xs font-medium leading-4 tracking-wider text-gray-500 uppercase">
                                                                แบ่งจ่าย<br />(แบ่งจ่าย)
                                                            </span>
                                                        </div>
                                                    </th>
                                                    <th class="px-3 py-3 text-left bg-gray-50 w-39">
                                                        <span class="text-xs font-medium leading-4 tracking-wider text-gray-500 uppercase">
                                                            ราคา<br />(เบิก)
                                                        </span>
                                                    </th>
                                                    ...
                                                    <th class="px-3 py-3 text-left bg-gray-50 w-50">
                                                        <span class="text-xs font-medium leading-4 tracking-wider text-gray-500 uppercase">
                                                            วิธีใช้
                                                        </span>
                                                    </th>
                                                    <th class="px-3 py-3 text-left bg-gray-50 w-40">
                                                        Action
                                                    </th>
                                                </tr>
                                            </thead>
                                            <tbody class="bg-white divide-y divide-gray-200 divide-solid">
                                                ...
                                                <tr class="bg-white">
                                                    <td class="px-6 py-4 text-sm leading-5 whitespace-no-wrap">
                                                        {{ ($drugs->currentPage() - 1) * $drugs->perPage() + $index + 1 }}
                                                    </td>
                                                    <td class="px-6 py-4 text-sm leading-5 whitespace-no-wrap">
                                                        {{$drug->code}}
                                                    </td>
                                                    ...
                                                    <td class="px-6 py-4 text-sm leading-5 whitespace-no-wrap">
                                                        {{ number_format($drug->prices / $drug->unitf, 2) }}
                                                    </td>
                                                    <td class="px-6 py-4 text-sm leading-5 whitespace-no-wrap text-gray-600">
                                                        {{$drug->description}}
                                                    </td>
                                                    <td class="px-6 py-4 text-sm leading-5 whitespace-no-wrap">
                                                        @if(isset($drug))
                                                        <x-danger-button
                                                            ...
                                                            wire:click="showFaculty({{ $drug->id }})">
                                                            Edit
                                                        </x-danger-button>
                                                        <x-danger-button
                                                            x-data=""
    ...
    <x-modal name="delete-modal" :show="$errors->isNotEmpty()" :maxWidth="'md'" focusable>
        <div class="p-6">
            ...
            <p class="mt-1 text-sm text-gray-600">
                {{ __('Are you sure you want to delete ยา?') }}
            </p>
            ...
            <div class="mt-6 flex justify-end">
                <div class="mt-4 flex justify-end">
                    ...
                    <x-danger-button class="ms-3"
                        x-on:click="deleteFaculty({{ $drug->id ?? null}})">
                        {{ __('Delete') }}
                    </x-danger-button>
                </div>
            </div>
