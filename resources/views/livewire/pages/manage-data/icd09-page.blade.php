                        ...
                        <div class="mx-auto max-w-7xl md:px-0 sm:px-6 lg:px-8">
                            <div class="overflow-hidden bg-white sm:rounded-lg">
                                <div class="flex justify-between items-end">
                                    <h4>ทั้งหมด {{$icd09s->total()}} รายการ</h4>
                                    ...
                                    <div class="min-w-full align-middle">
                                        <table class="min-w-full border divide-y divide-gray-200">
                                            ...
                                            <tbody class="bg-white divide-y divide-gray-200 divide-solid">
                                                ...
                                                @forelse($icd09s as $index => $icd9)
                                                <tr class="bg-white">
                                                    <td class="px-6 py-4 text-sm leading-5 whitespace-no-wrap">
                                                        {{ ($icd09s->currentPage() - 1) * $icd09s->perPage() + $index + 1 }}
                                                    </td>
                                                    <td class="px-6 py-4 text-sm leading-5 whitespace-no-wrap">
                                                        {{$icd9->code}}
                                                    </td>
                                                    ...
                                                    <td class="px-6 py-4 text-sm leading-5 whitespace-no-wrap">
                                                        ...
                                                        <x-danger-button
                                                            ...
                                                            wire:click="showFaculty({{ $icd9->id }})">
                                                            Edit
                                                        </x-danger-button>
                                                        <x-danger-button
                                                            x-data=""
    ...
    <x-modal name="delete-modal" :show="$errors->isNotEmpty()" :maxWidth="'md'" focusable>
        <div class="p-6">
            ...
            <p class="mt-1 text-sm text-gray-600">
                {{ __('Are you sure you want to delete icd9?') }}
            </p>
            ...
            <div class="mt-6 flex justify-end">
                <div class="mt-4 flex justify-end">
                    ...
                    <x-danger-button class="ms-3"
                        x-on:click="deleteFaculty({{ $icd9->id ?? null}})">
                        {{ __('Delete') }}
                    </x-danger-button>
                </div>
            </div>
